...
public class TargetDatePrayerActivity extends Activity implements TssfPrayerConstants {
	ScrollView scroll;
	LinearLayout linear;
	...
	private TextView getPrincpleRubricTextView() {
		...
		String pString = getString(R.string.TSSFPrincipleRubric) + " " + TssfUtils.getDayOfMonth(getDate()) + "\n";
	...
	private TextView getIntercessionRubricTextView() {
		...
		String pString = getString(R.string.TSSFIntercessionRubric) + " " + TssfUtils.getDayOfMonth(getDate()) + "\n";
